LANGUAGE_NAME := tree-sitter-desktop
HOMEPAGE_URL := https://github.com/valdezfomar/tree-sitter-desktop
VERSION := 1.1.1
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/desktop '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/desktop
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/desktop
