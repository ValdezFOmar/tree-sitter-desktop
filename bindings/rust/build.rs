fn main() {
    ...
    c_config.compile("tree-sitter-desktop");

    println!("cargo:rustc-check-cfg=cfg(with_highlights_query)");
    if !"queries/desktop/highlights.scm".is_empty() && std::path::Path::new("queries/desktop/highlights.scm").exists() {
        println!("cargo:rustc-cfg=with_highlights_query");
    }
    println!("cargo:rustc-check-cfg=cfg(with_injections_query)");
    if !"queries/desktop/injections.scm".is_empty() && std::path::Path::new("queries/desktop/injections.scm").exists() {
